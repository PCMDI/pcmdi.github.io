...
* Cite, as appropriate, one or more of the articles in the [CMIP6 GMD special issue](http://www.geosci-model-dev.net/special_issue590.html), which include an overview of the CMIP6 experiment design and descriptions of the CMIP6 Endorsed-MIPs, the CMIP6 forcing data sets, and the CMIP6 infrastructure.
