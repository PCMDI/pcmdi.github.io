...
* Cite, as appropriate, one or more of the articles in the [GMD special issue](http://www.geosci-model-dev.net/special_issue590.html), which include descriptions of the overall CMIP6 design, the CMIP6 endorsed-MIPs, the CMIP6 forcing data sets, and CMIP6 infrastructure.
* Cite CMIP6 model output used in your study as required by the CMIP6 [Data Citation Guidelines](http://bit.ly/2gBCuqM)
* Acknowledge the modeling groups, major supporters of CMIP6, and the WCRP with language similar to: “We acknowledge the World Climate Research Programme, which, through its Working Group on Coupled Modelling, coordinated and promoted CMIP6. We thank the climate modeling groups for producing and making available their model output, the Earth System Grid Federation (ESGF) for archiving the data and providing access, and the multiple funding agencies who support CMIP6 and ESGF.”
...
* Refer to the collection of CMIP6 models as the "CMIP6 multi-model ensemble" (or similar) and use as appropriate phrases like "CMIP6 multi-model [archive/output/results/of simulations/dataset/...] to describe CMIP6 products.
