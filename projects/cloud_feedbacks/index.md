...
This Cloud Feedback project is supported by the Regional and Global Climate Modeling ([RGCM](http://science.energy.gov/ber/research/cesd/regional-and-global-modeling/)) Programs of the U.S. Department of Energy's Office of Science/Biological and Environmental Research ([BER](http://science.energy.gov/ber/)).
...
* Study examines migration patterns of clouds (December 2016, ABC7 News)
* Clouds dampened warming since 1980s, study shows (October 2016, CarbonBrief)
* Recent pattern of cloud cover may have masked some global warming (October 2016, Ars Technica)
* Eliminating Uncertainty One Cloud at a Times (October 2016, Eos)
* Climate Change May Already Be Shifting Clouds Toward The Poles (July 2016, National Public Radio)
* Models overestimate rainfall increases due to climate change, experts say (December 2015, ScienceDaily)
* Low-Altitude Clouds Play an Important Role in a Changing Climate (November 2015, Eos)
* Cloud variations in current climate a guide to climate changes (December 2014. AGU)
* The cooling effect of clouds diminishes (October 2014, Deutschlandfunk) (pdf)
* Climate Scientist Aims to Clear the Air on Clouds (April 2014, LLNL)
* Cloudy forecast: The biggest source of climate uncertainty is white and fluffy (March 2014, ScienceNews)
* The madding cloud: When forecasting the future, scientists' blind spot is above them (January 2014, Grist)
* Ozone hole might slightly warm planet (August 2013, AGU)
* Reconciling Two New Cloud Feedback Papers (February 2013, SkepticalScience)
* Ocean clouds obscure warming's fate, create 'fundamental problem' for models (November 2012, E&E News)
* New tool clears the air on cloud simulations (October 2011, LLNL)
* Clouds confusion swirls at center of climate debate (September 2011, Live Science)
...
* Sanderson, B. M., R. Knutti, and P. M. Caldwell, 2015: Addressing interdepedency in a mutli-model ensemble by interpolation of climate models. J. Clim., 28, 5150-5170, doi: http://dx.doi.org/10.1175/JCLI-D-14-00361.1.

* Sanderson, B. M., R. Knutti, and P. M. Caldwell, 2015: A representative democracy to reduce interdependency in a multi-model ensemble. J. Clim., 28, 5171-5194, doi: http://dx.doi.org/10.1175/JCLI-D-14-00362.1.
